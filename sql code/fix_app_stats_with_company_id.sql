-- App statistics script - works after company_id columns are added to data tables
...
-- 3. Create function to get app statistics (updated to handle missing company_id gracefully)
