-- Simplified fix for app creation and statistics for multi-tenant system
...
-- 2. Create function to get app statistics
...
-- 3. Migrate existing company_apps to apps table (using correct column names)
...
-- 4. Create view for app details with statistics
