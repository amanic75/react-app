-- Fix app creation and statistics for multi-tenant system

-- 1. First, let's check if we need an apps table or if company_apps is sufficient
...
WHERE table_name IN ('apps', 'company_apps')
ORDER BY table_name, ordinal_position;

-- 2. Create or update apps table if needed
...
-- 4. Migrate existing company_apps to apps table
INSERT INTO apps (company_id, app_name, app_type, app_description, app_icon, app_color, status)
SELECT DISTINCT
  ca.company_id,
  ca.app_name,
