...
-- This script handles foreign key constraints, RLS policies, and column type changes

-- STEP 1: Drop foreign key constraints on assigned_to columns
...
-- STEP 2: Drop existing policies that reference assigned_to
...
-- STEP 3: Alter column types from UUID to UUID[]
...
-- STEP 4: Create indexes for better performance on array operations
...
-- STEP 5: Create a function to validate user IDs exist (since we can't use array foreign keys)
...
-- STEP 6: Create triggers to validate assigned users
...
-- STEP 7: Recreate policies with array support
